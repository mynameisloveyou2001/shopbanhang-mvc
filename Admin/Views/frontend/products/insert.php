				...
				<div class="form-group">
					<form method="post" action="index.php?controller=product&action=insert" enctype="multipart/form-data">
						...
						<div class="form-group">
							...
							<input required="true" type="number" class="form-control" id="price_sale" name="price_sale" value="">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<input required="true" type="file" multiple class="form-control" id="images" name="images[]" value="">
						</div>
<!--                         <label for="thumbnail">Nhà Cung Cấp</label>
				  	...
				  	<div class="form-group">
				  		...
				  		<textarea class="form-control" id="product_detail" rows="4" style="resize: none;" name="product_detail">
				  		</textarea>
				  	</div>
